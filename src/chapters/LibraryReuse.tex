...
Gesamtpaket identifiziert werden kann. Sie bietet alle nötigen Features\footnote{Liste aller Features der
jMonkeyEngine3: http://jmonkeyengine.org/engine/}, ist schon in der dritten Version verfügbar (somit ist von einem
