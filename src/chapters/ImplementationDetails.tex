...
ausschließlich als Testplattform für den Netzcode eines großen Spiels geschrieben wird. So entstand zum Beispiel
...
Wenn ein neuer Spieler dem Spiel beitritt, registriert sich seine Client-Instanz zunächst beim Server. Der Server
bestätigt die Verbindung und schickt dem Client auf dessen Nachfrage den aktuellen Zustand der Spielwelt, der anderen
Spieler und des Spielverlaufs. Der Spieler bekommt nun ein Einstiegsmenü angezeigt, in dem er das Team wählen kann.
Sobald der Spieler seine Auswahl bestätigt, sendet der Client den Spielerbeitritt-Befehl an den Server. Dieser
informiert alle Client-Instanzen über den Beitritt und die Daten des neuen Spielers. Der Client des Spielers sendet den
